            ...
            <div class="col-10 offset-1">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <form action="{{ route('add.people') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" name="about" placeholder="Tell us about yourself ..." id="floatingTextarea"></textarea>
                    ...
                    <tbody>
                        @foreach ($peoples as $people)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('view.people', $people->id) }}" class="btn btn-primary">View
                                    ...
                                    <a href="{{ route('edit.people', $people->id) }}" class="btn btn-warning">Update
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <a href="{{ route('delete.people', $people->id) }}" class="btn btn-danger">Delete
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
